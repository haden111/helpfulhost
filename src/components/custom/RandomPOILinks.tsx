...
import { ArrowRightCircle, ListChecks, Info } from 'lucide-react'; // Using a generic icon
...
interface POILink {
  code: string;
  title: string;
  // We could add a specific icon lookup here if instructionsData had icon info
}
